...
describe('arrayCubeRootToJson', () => {
  ...
  it('throw cases', () => {
    expect(() => { new arrayCubeRootToJson({}) }).toThrow();
    expect(() => { new arrayCubeRootToJson(true) }).toThrow();
    expect(() => { new arrayCubeRootToJson([null, false]) }).toThrow();
    expect(() => { new arrayCubeRootToJson(false) }).toThrow();
    expect(() => { new arrayCubeRootToJson(undefined) }).toThrow();
    expect(() => { new arrayCubeRootToJson([1, 2, 4, 'abc']) }).toThrow();
    expect(() => { new arrayCubeRootToJson([1, 2.12, 4.44, 'abc']) }).toThrow();
  });
});
